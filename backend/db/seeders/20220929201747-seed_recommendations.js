module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('Recommendations', [
      {
        conditionId: 1,
        recommendation: `Медиативные техники
      ...
      {
        conditionId: 1,
        recommendation: `Положительный настрой
      ...
      {
        conditionId: 1,
        recommendation: `Упражнение «Мотивация»
      ...
      {
        conditionId: 2,
        recommendation: `Аутогенные тренировки
      ...
      {
        conditionId: 2,
        recommendation: `Дыхательные упражнения
      ...
      {
        conditionId: 2,
        recommendation: `Представь худший сценарий
      ...
      {
        conditionId: 3,
        recommendation: `Обрати внимание на свое состояние 
      ...
      {
        conditionId: 3,
        recommendation: `Признай тревогу
      ...
      {
        conditionId: 3,
        recommendation: `Упражнение «Черный список»
      ...
      {
        conditionId: 4,
        recommendation: `Методика переключения эмоций
